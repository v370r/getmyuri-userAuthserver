...
// import static
// com.getmyuri.user_auth_service.common.constants.EmailConstants.ACTIVATION_ACTIVATION;
// import static
// com.getmyuri.user_auth_service.common.constants.EmailConstants.DIGITS;
...
// // import com.getmyuri.user_auth_service.service.RefreshTokenService; //
// Removed import
...
// @Slf4j
// @ConditionalOnProperty(name = "auth.mode", havingValue = "db", matchIfMissing
// = false)
...
// // private final RefreshTokenService refreshTokenService; // Removed
// // RefreshTokenService
...
// .orElseThrow(() -> new IllegalStateException("ROLE USER was not
// initialized"));
...
// log.info("Generating and saving activation token for user: {}",
// user.getEmail());
...
// var auth = authenticationManager.authenticate(new
...
// @Transactional
// public void activateAccount(String token, String email) throws
// MessagingException {
...
// !email.equalsIgnoreCase(userFromToken.getEmail())) {
// throw new RuntimeException("Invalid token or email");
// }

// if (LocalDateTime.now().isAfter(savedToken.getExpiresAt())) {
// sendValidationEmail(savedToken.getUser());
// throw new RuntimeException("Activation token has expired. A new token is
// issued");
// }
