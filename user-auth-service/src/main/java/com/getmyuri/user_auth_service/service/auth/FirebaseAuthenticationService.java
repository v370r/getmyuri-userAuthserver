...
@Slf4j
@ConditionalOnProperty(name = "auth.mode", havingValue = "firebase")
public class FirebaseAuthenticationService {
    ...
    public void register(RegistrationRequest request) throws MessagingException, ExecutionException, InterruptedException, FirebaseAuthException {
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) throws ExecutionException, InterruptedException {
    ...
    public void activateAccount(String token, String email) throws MessagingException, ExecutionException, InterruptedException {
